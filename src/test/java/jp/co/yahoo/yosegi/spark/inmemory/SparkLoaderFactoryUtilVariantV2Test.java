...
class SparkLoaderFactoryUtilVariantV2Test {
  @Test
  void T_createLoaderFactory_VariantExtractionStruct() {
    ...
    final WritableColumnVector vector = new OnHeapColumnVector(5, type);
    final ILoaderFactory<WritableColumnVector> factory =
        SparkLoaderFactoryUtil.createLoaderFactory(vector);
    assertTrue(factory instanceof SparkVariantStructLoaderFactory);
  }
